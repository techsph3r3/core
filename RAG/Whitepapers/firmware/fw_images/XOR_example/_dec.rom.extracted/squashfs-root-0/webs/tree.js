...
{   
  ...
  { 
    if (folder.nodeImg) 
      if (folder.isLastNode) 
        folder.nodeImg.src = "mlastnod.gif" 
      else 
	  folder.nodeImg.src = "mnode.gif" 
    folder.iconImg.src = "folderop.gif" 
  ...
  { 
    if (folder.nodeImg) 
      if (folder.isLastNode) 
        folder.nodeImg.src = "plastnod.gif" 
      else 
	  folder.nodeImg.src = "pnode.gif" 
    folder.iconImg.src = "foldercl.gif" 
    for (i=0; i<folder.nChildren; i++) 
...
{ 
  ...
  if (level>0) 
    ...
    { 
      this.renderOb(leftSide + auxEv + "<img name='nodeIcon" + this.id + "' src='mlastnod.gif' width=16 height=22 border=0></a>") 
...
{ 
  ...
  doc.write("<table ") 
  if (browserVersion == 1) 
    doc.write(" id='folder" + this.id + "' style='position:static;' ") 
...
{ 
  if (this.hreference) 
  { 
//	doc.write("<a href='" +	this.hreference	+ "' TARGET=此處改成Frame名稱 ")
...
{ 
  ...
  this.iconSrc = "foldercl.gif" //"ftv2doc.gif" 
...
{ 
  ...
  doc.write("<table ") 
  if (browserVersion == 1) 
    doc.write(" id='item" + this.id + "' style='position:static;' ") 
  doc.write(" border=0 cellspacing=0 cellpadding=0>") 
  doc.write("<tr><td>") 
  doc.write(leftSide) 
...
function initializeDocument(show) 
{     
  if (doc.all) 
...
{ 
  description="<font style=font-size:9pt; font-face:Arial; font-color: #00ff00;background-color:#ccff99>" + description
