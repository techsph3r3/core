...
def runWorld():
    ...
    pygame.display.set_caption("CybatiWorks Bottle-Filling Factory - World View - VirtuaPlant")
    ...
    while running:
        ...
        # CybatiWorks Branding
        logo = pygame.image.load("/opt/CybatiWorks/CybatiWorks_Basic_HMI.png")
        name = fontMedium.render(str("Bottle-filling VirtuaPlant factory"), 1, THECOLORS['deepskyblue'])        
        title = fontMedium.render(str("Bottle-filling VirtuaPlant factory"), 1, THECOLORS['deepskyblue'])
...
identity.VendorName  = 'CybatiWorks MockPLCs'
identity.ProductCode = 'CybatiWorks MP'
