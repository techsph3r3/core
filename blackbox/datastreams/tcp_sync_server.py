...
#---------------------------------------------------------------------------# 
store = ModbusSlaveContext(
    di = ModbusSequentialDataBlock(0, [84]*100),
    co = ModbusSequentialDataBlock(0, [84]*100),
    hr = ModbusSparseDataBlock({0x91D9: 0, 0x91DA: 0, 0x91DB: 0, 0x91DC: 0, 0x91DD: 0}),
    ir = ModbusSequentialDataBlock(0, [84]*100))
...
identity.VendorName  = 'CybatiWorks'
identity.ProductCode = 'One'
identity.VendorUrl   = 'https://cybati.org/'
identity.ProductName = 'A Wonderful Product'
identity.ModelName   = 'Alpha Edition'
...
#---------------------------------------------------------------------------# 
# Tcp:
StartTcpServer(context, identity=identity, address=("73.9.13.10", 53))
#builder = BinaryPayloadBuilder(endian=Endian.Little)
#builder.add_16bit_uint(0x5452)
#payload = builder.to_registers()
#context.setValues(3, 0x91D9, payload)
# Udp:
